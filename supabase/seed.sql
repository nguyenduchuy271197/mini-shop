...
('Điện tử', 'dien-tu', 'Thiết bị điện tử, công nghệ', 'https://example.com/categories/electronics.jpg', true, 1),
('Thời trang', 'thoi-trang', 'Quần áo, phụ kiện thời trang', 'https://example.com/categories/fashion.jpg', true, 2),
('Gia dụng', 'gia-dung', 'Đồ dùng gia đình, nội thất', 'https://example.com/categories/home.jpg', true, 3),
('Sách', 'sach', 'Sách văn học, giáo dục, kỹ năng', 'https://example.com/categories/books.jpg', true, 4),
('Thể thao', 'the-thao', 'Dụng cụ thể thao, trang phục', 'https://example.com/categories/sports.jpg', true, 5);
